...
import com.entlogics.hotelbookingsystemjpa.utilities.HotelUtilities;
...
public class HotelService implements IHotelService {
	...
	@Autowired
	private HotelUtilities hotelUtilities;
	...
	public List<HotelDTO> getListOfHotels(String hotels) {
		...
		String hotel_name = String.valueOf(hotels).equals(hotels) ?  hotels : ""; 
